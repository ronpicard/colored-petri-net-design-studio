"""
This script is called by the plugin-wrapper, TotalRun.js, which passes down the
...
plugin = TotalRun(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
