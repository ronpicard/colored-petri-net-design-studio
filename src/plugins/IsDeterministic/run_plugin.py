"""
This script is called by the plugin-wrapper, IsDeterministic.js, which passes down the
...
from IsDeterministic import IsDeterministic
...
plugin = IsDeterministic(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
