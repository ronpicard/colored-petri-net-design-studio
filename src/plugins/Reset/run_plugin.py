"""
This script is called by the plugin-wrapper, Reset.js, which passes down the
...
plugin = Reset(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
