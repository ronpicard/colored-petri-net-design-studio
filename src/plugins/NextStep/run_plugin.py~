"""
This script is called by the plugin-wrapper, NextStep.js, which passes down the
...
plugin = NextStep(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
