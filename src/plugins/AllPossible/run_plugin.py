"""
This script is called by the plugin-wrapper, AllPossible.js, which passes down the
...
from AllPossible import AllPossible
...
plugin = AllPossible(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
