"""
This script is called by the plugin-wrapper, SetInitialState.js, which passes down the
...
from SetInitialState import SetInitialState
...
plugin = SetInitialState(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
